...
const OnboardingSplash: React.FC<OnboardingSplashProps> = ({ open, onFinish }) => {
  ...
  const slides: Slide[] = useMemo(
    () => [
        ...
        body: (
          <>
            <p className="splashText">
              Данное веб-приложение выполнено студенткой группы <b>9ИС-205</b> —{" "}
              <b>Зайцевой Дарьей Денисовной</b> — для производственной практики <b>ПМ.08</b>.
            </p>
      ...
      {
        title: "Почему я сделала этот инструмент",
        body: (
          <>
            <p className="splashText">
              Я хотела глубже разобраться с <b>Framer Motion</b> и работой с <b>Canvas/3D</b> в браузере.
              При этом я дизайнер, поэтому решила сделать практичный инструмент, который реально пригодится:
            </p>
